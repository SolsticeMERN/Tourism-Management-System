...
const UpdateTourismSpot = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Update TouristsSpot- TTravol</title>
        <meta name="description" content="Description of Register" />
      </Helmet>
      <div className="bg-white border md:border-4 rounded-lg shadow relative m-10">
        <div className="flex items-start justify-between p-5 border-b rounded-t">
          <h3 className="text-xl font-semibold">Update Tourists Spot</h3>
          <button
            type="button"
            ...
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-full">
                ...
                <textarea
                  ...
                  placeholder="Ancient amphitheater for gladiator contests"
                ></textarea>
              </div>
            </div>
